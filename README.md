![docker image](https://github.com/Guillaume-Gaisne/NOMAD_plugin_installation/actions/workflows/docker-publish.yml/badge.svg)
...
```sh
curl -L -o nomad-oasis.zip "https://github.com/Guillaume-Gaisne/NOMAD_plugin_installation/raw/main/nomad-oasis.zip"
```
...
your `docker-compose.yaml` with `ghcr.io/Guillaume-Gaisne/NOMAD_plugin_installation:main` for the services
 ...
 *I get an* `Error response from daemon: Head "https://ghcr.io/v2/Guillaume-Gaisne/NOMAD_plugin_installation/manifests/main": unauthorized`
